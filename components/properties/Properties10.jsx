...
import PropertyGridItems3 from "./PropertGridItems3";
import PropertyListItems3  from "./PropertyListItems3";
import PropertyGridItems from "./PropertyGridItems";
import PropertyListItems from "./PropertyListItems";

export default function Properties10({ defaultGrid = false }) {
  return (
