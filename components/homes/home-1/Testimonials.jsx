            ...
            <div className="content">
              ...
              <ul className="img-group">
                <li>
                  <Image
                    alt="avatar"
                    src="/images/banner/avatar-4.webp"
                    width={128}
                    height={128}
                  />
                </li>
                <li>
                  <Image
                    alt="avatar"
                    src="/images/banner/avatar-8.webp"
                    width={128}
                    height={128}
                  />
                </li>
                <li>
                  <Image
                    alt="avatar"
                    src="/images/banner/avatar-7.webp"
                    width={128}
                    height={128}
                  />
                </li>
                <li>
                  <Image
                    alt="avatar"
                    src="/images/banner/avatar-6.webp"
                    width={128}
                    height={128}
                  />
                </li>
                <li>
                  <Image
                    alt="avatar"
                    src="/images/banner/avatar-5.webp"
                    width={128}
                    height={128}
                  />
                </li>
